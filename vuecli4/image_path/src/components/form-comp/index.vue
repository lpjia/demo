  ...
  <div id="content" class="train-container" v-cloak>
    ...
    <div class="main">
      ...
      <div class="bigCard">
        <div class="title">
          <div class="titleIcon">
            <!-- <img src="/imgs/form-comp/user_icon.png" alt="不通过webpack处理"> -->
            <!-- <img src="@/assets/imgs/form-comp/user_icon.png" alt="在template中直接引用, 使用@"> -->
            <img src="../../assets/imgs/form-comp/user_icon.png" alt="在template中直接引用, 使用相对路径">
          </div>
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="30%">
      <div>
        <div class="imgSection">
          <img src="/imgs/form-comp/dui.png" alt="">
        </div>
...
/* webpack 2及以上版本默认支持导入json文件 */
import pageData from './mock/pageDataJson.json'
...
export default {
  ...
  data() {
    return {
      ...
      avatarDefaultUrl: '/imgs/form-comp/avatar.png',
  ...
  computed: {
    majorListFilter() {
      return (k) => {
        let idx = null
        let newArr = cloneDeep(this.majorList)
        newArr.map((item, i) => {
...
.train-container {
  .topBg {
    /* public 目录, 绝对路径 */
    // background: url('/imgs/form-comp/bj.png') no-repeat center;
    /* @/assets 目录 */
    background: url('~@/assets/imgs/form-comp/bj.png') no-repeat center;
