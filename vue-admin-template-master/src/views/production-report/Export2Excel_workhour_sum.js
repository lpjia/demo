...
export function export_json_to_excel({
  ...
  // 设置主标题样式
  let changeHeaderStyleArr = []
  for (let i of mergesA) {
    let item = i.split(':')[0]
    changeHeaderStyleArr.push(item)
  }
  // console.log('changeHeaderStyleArr:', changeHeaderStyleArr)
  // console.log('dayTotal:', dayTotal)
  changeHeaderStyleArr = changeHeaderStyleArr.concat(mergesB)
  // console.log('changeHeaderStyleArr:', changeHeaderStyleArr)
