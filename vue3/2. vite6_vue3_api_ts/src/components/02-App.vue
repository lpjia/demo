<template>
  <div>
    ...
    <ChildApp :count="count2" :cNumVal="cNum.val" />
    <hr>
...
/* Ref类型 */
const ns: Ref<number | string> = ref('2000')
// const ns = ref<number | string>('2000')
ns.value = 2000
